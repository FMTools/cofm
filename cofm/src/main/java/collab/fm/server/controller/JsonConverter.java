...
public class JsonConverter {
	...
	static {
		...
		requestClassMap.put(Resources.REQ_FOCUS_ON_FEATURE, FocusOnEntityRequest.class);
		...
		requestClassMap.put(Resources.REQ_EA_ATTR_ENUM, EditAddEnumAttributeDefRequest.class);
