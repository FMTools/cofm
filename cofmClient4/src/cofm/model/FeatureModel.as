package cofm.model
{
	...
	public class FeatureModel implements IOperationListener {
		...
		*/
		...
		[Bindable] public var features: XMLListCollection;
		[Bindable] public var binaries: XMLListCollection;
		[Bindable] public var attrs: XMLListCollection;
		
		private var _subViews: Array = new Array();
		
		private static var _instance: FeatureModel = new FeatureModel();
		
		public static function instance(): FeatureModel {
			return _instance;
		}
		
		public function FeatureModel() {
			features = new XMLListCollection(new XMLList(_defaultXml.feature));
			binaries = new XMLListCollection(new XMLList(_defaultXml.binary));
			attrs = new XMLListCollection(new XMLList(_defaultAttrs.attr));
