...
//		
//		List<FeatureOld> features = DaoUtil.getFeatureDao().getAll(m.getId());
...
//	}
//	
//	protected void reportFeatureDetails(List<FeatureOld> list) {
//		logger.info(NL + "=== Feature/Attribute/Value details ===");
//		logger.info(FEATURE_DETAILS_HEADER);
//		if (list == null) {
//			return;
//		}
//		for (FeatureOld f: list) {
//			reportFeature(f);
//		}
//	}
//	
//	protected void reportFeature(FeatureOld f) {
